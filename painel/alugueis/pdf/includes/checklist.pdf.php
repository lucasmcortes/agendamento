...
$html .= '
	<p style="min-width:100%;max-width:100%;font-size:11px;text-align:justify;">
		Eu, <b>'.$cliente['nome'].'</b>, CPF <b>'.$cliente['documento'].'</b>, rg <b>'.$cliente['rg'].'</b>, declaro para os devidos fins de direito que na presente data peguei a título de <b>competente RESERVA</b> o automóvel <b>'.$competente['modelo'].'</b>, placa <b>'.$competente['placa'].'</b> às <b>'.$inicio->format('H').'h'.$inicio->format('i').'</b> e o entregarei num prazo de <b>'.$prazohoras.'h</b>.
                Sei que sou responsável para arcar com a participação obrigatória de <b>'.Dinheiro($aluguel['valor_caucao']).'</b> em caso de acidente, furto ou roubo do mesmo; também sou responsável por danos a terceiros, multas e quaisquer infrações que ocorrerem durante o período em que o competente se encontrar em meu poder.
