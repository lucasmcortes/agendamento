...
<table>
        <tr style="border:1px solid #000000;">
                <th colspan="2">
                        <br/><br/><br/><br/><img src="'.$dominio.'/img/46logo.png" width="90"/>
                </th>
                <th colspan="10">
...
<table>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>cliente</b>: '.$cliente['nome'].', residente em '.$cliente['rua'].', '.$cliente['numero'].', '.$cliente['bairro'].' - '.$cliente['cidade'].' - '.$cliente['estado'].', inscrito no CPF sob o nº '.$cliente['documento'].', rg nº '.$cliente['rg'].'.
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>Cláusula 1ª</b>. O presente contrato tem como OBJETO a locação do competente
                        '.$competente['modelo'].', ano '.$competente['ano'].', chassi '.$competente['chassi'].', cor predominantemente '.mb_strtolower($competente['cor']).', placa '.$competente['placa'].'
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        ...
                        cliente para serviço PARTICULAR, não sendo permitido o seu uso por terceiros, sob
                        pena de rescisão contratual e o pagamento da multa prevista na Cláusula 5.1. É de total
                        responsabilidade do cliente qualquer dano material ocorrido no competente, assim como quaisquer infrações
                        de trânsito.
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>2.1</b>. O LOCADOR não constituirá nenhum vínculo empregatício caso o cliente se utilize
                        do competente para fins lucrativos no transporte de terceiros ou de cargas, prevalecendo sempre o
                        objeto deste contrato somente a locação do competente mencionado pactuada de comum acordo
                        entre as partes. O competente objeto deste contrato será utilizado exclusivamente para fins
                        lícitos e particulares, permitidos pelos diplomas legais vigentes. Caso ocorra a violação desta
                        cláusula, a responsabilidade civil ou criminal será inteiramente do cliente.
                </th>
        </tr>
...
<table>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>Cláusula 3ª</b>. O cliente deverá devolver o competente ao locador nas mesmas condições
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>3.1</b>. O cliente vistoriou o competente dado em locação por este instrumento, quando
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>3.2</b>. REPAROS E CONSERVAÇÃO – O cliente recebe o bem em perfeitas condições de
                        limpeza, conservação e funcionamento, obrigando-se a mantê-lo como tal. Para reposição de
                        peças o cliente deve utilizar peças originais e especificadas pela montadora do
                        competente.
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>Cláusula 5ª</b>. Caso não ocorra a restituição do competente ao LOCADOR pelo cliente dentro do período estipulado, este deverá pagar,
                        pelo período em que o detiver em seu poder, o valor que o LOCADOR arbitrar, e responderá por quaisquer danos
                        que o competente venha a sofrer durante todo o período, ainda que decorrente de caso fortuito ou força maior.
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>5.2</b>. Caso haja atraso no pagamento o LOCADOR poderá reaver a posse do competente sem
...
<table>
        ...
        <tr style="line-height:34px;">
                <th colspan="8" style="text-align:center;"><b>DEVERES DO cliente</b></th>
        </tr>
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>Cláusula 6ª</b>. O cliente assume e isenta o LOCADOR a proteção contra danos pessoais,
                        bem como danos que por ventura venha a sofrer ele próprio, pessoa de sua família,
                        pedestres e passageiros que estiverem ocupando o competente, morte ou lesão corporal de
                        ...
                        cobrado posteriormente. Os danos materiais de terceiros em competentes que ultrapassem o limite
                        da proteção contratada pelo LOCADOR, bem como danos morais, danos pessoais derivados
                        do evento danoso, serão de responsabilidade única do cliente.
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        ...
                        cliente, por meio do qual, o LOCADOR, mediante o pagamento de uma taxa mensal que
                        varia de acordo com a proteção escolhida e o grupo do competente, através de contrato de adesão
                        feito com “Associação dos proprietários de competentes automotores”.
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>6.2</b>. Além do aluguel acima estipulado, o cliente pagará todos os impostos ou quaisquer
                        outras despesas que recaiam ou venham a recair sobre o competente locado, inclusive franquia,
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>Cláusula 7ª</b>. O cliente assume todos os encargos legais como pagamento de multas,
                        pontos na rg e penalidades decorrentes de infrações às leis e regulamentos de trânsito,
                        durante o período que estiver de posse do competente, mesmo que o débito venha a ser
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>7.1</b>. O cliente assume as despesas de combustível.
                </th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>7.2</b>. O cliente fica responsável pelo pagamento no valor de '.Dinheiro($aluguel['valor_caucao']).' ('.ltrim(extenso($aluguel['valor_caucao']),' ').') em forma de caução para resguardo de acionamento da franquia ou caso haja
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>7.3</b>. O cliente obriga-se a fornecer estacionamento para o competente em condições de
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:justify;">
                        <b>7.4</b>. O cliente obriga-se a comunicar imediatamente ao LOCADOR ocorrência de
...
<table>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:center;">Juiz de Fora, '.$agora->format('d').' de '.strftime('%B', strtotime($agora->format('Y-m-d'))).' de '.$agora->format('Y').'</th>
        </tr>
        <tr style="line-height:55px;">
                <th colspan="8" style="text-align:center;"></th>
        </tr>
        ...
        <tr style="line-height:21px;">
                <th colspan="8" style="text-align:center;">'.$cliente['nome'].'</th>
        </tr>
        <tr style="line-height:55px;">
                <th colspan="8" style="text-align:center;"></th>
        </tr>
