...
if (move_uploaded_file($fileTmpLoc, $arquivo_url_completo)) {
        ...
        if ($extensao_img=='.pdf') {
                $resultimgimg_foto .= "
                        <iframe id='fotoimg' src='".$dominio."/painel/competentes/novo/temp/".$nome_completo_arquivo."' style='width:100%;auto;'></iframe>
                ";
        } else {
                $resultimgimg_foto .= "
                        <img id='fotoimg' style='max-width:222px;width:100%;height:auto;' src='".$dominio."/painel/competentes/novo/temp/".$nome_completo_arquivo."'></img>
                ";
        }
