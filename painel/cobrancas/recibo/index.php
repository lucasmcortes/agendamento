					...
					<div style='min-width:90%;max-width:90%;display:inline-block;margin:1.8% auto;'>
						...
						<div style='min-width:100%;max-width:100%;display:inline-block;padding:1.8% 3%;padding-top:0;'>
							...
							<div class='wrapcampo'>
								...
								<div class='camporecibo'><input class='inputrecibo' type='text' placeholder='Data' name='datarecibo' id='datarecibo' value='<?php echo $agora->format('d').' de '.strftime('%B', strtotime($agora->format('Y-m-d'))).' de '.$agora->format('Y') ?>' maxlength='23'></input></div>
