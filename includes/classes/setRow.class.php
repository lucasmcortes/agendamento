<?php
	...
	class setRow extends Conexao {
		...
		public function Agendamento($guid,$uid,$lid,$vid,$agendamento,$especificacao,$ativo,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO agendamento (guid, uid, lid, vid, agendamento, especificacao, ativo, data) VALUES(?, ?, ?, ?, ?, ?, ?, ?);");
				$stmt->execute([$guid,$uid,$lid,$vid,$agendamento,$especificacao,$ativo,$data]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		...
		public function Cliente($uid,$nome,$documento,$telefone,$email,$nascimento,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO cliente (uid, nome, documento, telefone, email, nascimento, data_cadastro) VALUES(?, ?, ?, ?, ?, ?, ?)");
		...
		public function Competente($uid,$nome,$ativo,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO competente (uid, nome, ativo, data_cadastro) VALUES(?, ?, ?, ?);");
				$stmt->execute([$uid,$nome,$ativo,$data]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		...
		public function Cobs($uid,$vid,$observacao,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO cobs (uid, vid, observacao, data_mod) VALUES(?, ?, ?, ?);");
				$stmt->execute([$uid,$vid,$observacao,$data]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		...
		public function Documento($uid,$lid,$o_exp,$numero,$data_cadastro) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO documento (uid, lid, o_exp, numero, data_cadastro) VALUES(?, ?, ?, ?, ?)");
				$stmt->execute([$uid,$lid,$o_exp,$numero,$data_cadastro]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		...
		public function HorarioInicioExpediente($uid,$hora,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO cfig_exp_inicio (uid, hora, data_mod) VALUES(?, ?, ?)");
				$stmt->execute([$uid,$hora,$data]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		} // HorarioInicioExpediente

		public function HorarioEncerramentoExpediente($uid,$hora,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO cfig_exp_encerramento (uid, hora, data_mod) VALUES(?, ?, ?)");
				$stmt->execute([$uid,$hora,$data]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		} // HorarioEncerramentoExpediente

		public function DuracaoIntervaloAgendamento($uid,$minutos,$data) {
			try {
				$stmt = $this->conectar()->prepare("INSERT INTO cfig_exp_intervalo (uid, minutos, data_mod) VALUES(?, ?, ?)");
				$stmt->execute([$uid,$minutos,$data]);
				return true;
			} catch(PDOException $erro) {
				return $erro->getMessage();
			}
		} // DuracaoIntervaloAgendamento
