<?php
        ...
        if ($title == $titulo_servidor) {
                ...
                $title =  'Ophanim | Organize seus agendamentos';
        } else {
                // outros
                $title =  'Ophanim | Organize seus agendamentos';
        }

        $head_desc = 'Cadastre seus agendamentos, organize e gerencie em um sistema especial e tenha todas as suas movimentações em relatórios disponíveis pra você.';
