<?php
	...
	$imagem = glob(__DIR__.'/../painel/competentes/foto/'.$_SESSION['placa'].'.*', GLOB_BRACE);
	if (!empty($imagem)) {
...
?>
	...
	<div style="overflow:auto;height:auto;max-height:81vh;">
		<img class='fotoimg' style='max-width:300%;max-height:300%;' src='<?php echo $dominio ?>/painel/competentes/foto/<?php echo $imagem."?".rand(1, 999) ?>'></img>
	</div>
	<!-- items -->
