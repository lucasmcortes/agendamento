			       ...
			       <div style='display:flex;flex-direction:column;align-items:center;'>
					<div id="id03">
							...
							<div id="container-cadastro" class="container-cadastro">
								<label>Nome</label>
								<input type="text" value="<?php echo $_SESSION['ag_nome']??'' ?>" id="nome" placeholder="Seu nome completo" name="nome">

			                    			<div style="display:flex;gap:2%;">
									<div style="flex:1;">
										<label>E-mail</label>
					                        		<input type='text' value="<?php echo $_SESSION['ag_email']??'' ?>" id="email" placeholder="Seu e-mail" name='email'>
									</div>
									<div style="flex:1;">
										<label>Telefone</label>
				                        			<input onkeyup="maskIt(this,event,'(##) ###-###-###')" type='text' value="<?php echo $_SESSION['ag_telefone']??'' ?>" id="telefone" placeholder="(99) 999-999-999" name='telefone'>
				                    			</div>
								</div>
